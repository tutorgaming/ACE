...
#include <map>
#include <utility>
#include "angen_gazebo/AngenContactState.h"
...
class room_identifier
{
   ...
   public:
        room_identifier() 
        { 
          bedroom_contact_subscriber = angen_contact_handle.subscribe("/angen_contact/bedroom/state", 1000, &room_identifier::bedroom_contact_callback, this);
          kitchen_contact_subscriber = angen_contact_handle.subscribe("/angen_contact/kitchen/state", 1000, &room_identifier::kitchen_contact_callback, this);
          workroom_contact_subscriber = angen_contact_handle.subscribe("/angen_contact/workroom/state", 1000, &room_identifier::workroom_contact_callback, this); 
          entranceway_contact_subscriber = angen_contact_handle.subscribe("/angen_contact/entranceway/state", 1000, &room_identifier::workroom_contact_callback, this);
          livingroom_contact_subscriber = angen_contact_handle.subscribe("/angen_contact/livingroom/state", 1000, &room_identifier::workroom_contact_callback, this);
