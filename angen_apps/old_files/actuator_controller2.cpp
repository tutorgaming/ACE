...
int main(int argc, char **argv)
 {
   ...
   std::string file, bulb_name, light_name, door_name, window_name, room_name=argv[3], status=argv[2], actuator1=argv[1];
   ...
   switch(actuator[room_name])
    {
      case LIVINGROOM:
       ...
       bulb_name = std::string("bulb_lr");
       light_name = std::string("light_lr");
      ...
      case WORKROOM:
       ...
       bulb_name = std::string("bulb_wr");
       light_name = std::string("light_wr");
      ...
      case KITCHEN:
       ...
       bulb_name = std::string("bulb_k");
       light_name = std::string("light_k");
      ...
      case BEDROOM:
       ...
       bulb_name = std::string("bulb_ber");
       light_name = std::string("light_ber");
      ...
      case BATHROOM:
       ...
       bulb_name = std::string("bulb_bar");
       light_name = std::string("light_bar");
      ...
      case CLOSET:
       ...
       bulb_name = std::string("bulb_c");
       light_name = std::string("light_c");
      ...
      case BALCONY:
       ...
       bulb_name = std::string("bulb_bac");
       light_name = std::string("light_bac");
      ...
      case ROOM_1:
       ...
       bulb_name = std::string("bulb_r1");
       light_name = std::string("light_r1");
      ...
      case ROOM_2:
       ...
       bulb_name = std::string("bulb_r2");
       light_name = std::string("light_r2");
      ...
      case ROOM_3:
       ...
       bulb_name = std::string("bulb_r3");
       light_name = std::string("light_r3");
      ...
      case ROOM_4:
       ...
       bulb_name = std::string("bulb_r4");
       light_name = std::string("light_r4");
      ...
      case ROOM_5:
       ...
       bulb_name = std::string("bulb_r5");
       light_name = std::string("light_r5");
      ...
      case ROOM_6:
       ...
       bulb_name = std::string("bulb_r6");
       light_name = std::string("light_r6");
      ...
      case ROOM_7:
       ...
       bulb_name = std::string("bulb_r7");
       light_name = std::string("light_r7");
